package az.savey.ms.savey.logger;
...
/**
 * Secure Logger class - This class helps to prevent CRLF Injection in logs.
 * CRLF injection vulnerabilities occur when data enters an application from an untrusted source
 * and is not properly validated before being used.
 * Read more about this: http://cwe.mitre.org/data/definitions/117.html
 */
